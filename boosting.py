...
#     train_sizes, train_scores, valid_scores, y_test, y_pred = run_boosting(flower_X, flower_y)

#     plt.figure()
#     plt.title("Adaboost Classifier Learning Curves: Iris Data")
#     plt.xlabel("Training examples")
#     plt.ylabel("Score")
#     train_scores_mean = np.mean(train_scores, axis=1)
#     train_scores_std = np.std(train_scores, axis=1)
...
#     train_sizes, train_scores, valid_scores, y_test, y_pred = run_boosting(heart_X, heart_y)

#     plt.figure()
#     plt.title("Adaboost Learning Curves: Heart Disease Data")
#     plt.xlabel("Training examples")
#     plt.ylabel("Score")
#     train_scores_mean = np.mean(train_scores, axis=1)
#     train_scores_std = np.std(train_scores, axis=1)
